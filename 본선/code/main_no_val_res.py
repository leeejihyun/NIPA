...
if __name__ == '__main__':
    ...
    args.add_argument("--print_iter", type=int, default=200)
    ...
    args.add_argument("--loss_plot", type=str, default='/home/workspace/user-workspace/leeejihyun/loss/loss.png')
...
#             scheduler.step()
            ...
            # save model
            save_model('/home/workspace/user-workspace/leeejihyun/model/'+str(epoch + 1), model, optimizer)
